...
We can see that the two most powerful predictors are % of students on pupil premium (-0.44SD), number of GCSEs offered (+0.4SD), % of students who are EAL (+0.3SD), and a school being religiously affiliated (+0.18SD). The total pupil population `TPUP` is also significantly associated with P8 score, but the Beta value is small, at +0.06SD:
...
Looking at mixed schools only, we can see that an increase of 1SD in the number of girls in your school `GPUP` results in +0.09SD P8 increase. Boys `BPUP` remain statistically insignificant.
