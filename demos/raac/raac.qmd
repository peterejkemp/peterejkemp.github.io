---
title: "RAAC in English schools - 2023-10-19"
format: 
  html:
    toc: true
author:
...
raac_raw <- read_excel(glue(basefolder, "_reports/RAAC/RAAC.xlsx"), 
  ...
  dplyr::rename("setting_mitigation" = "setting_mitigation_16_10_2023")
...
A very quick lunchtime report on school providers with RAAC and their mitigation plans. Data from [here](https://www.gov.uk/government/publications/reinforced-autoclaved-aerated-concrete-raac-management-information) and up to date as of 2023-10-19, using the DfE dataset that states: "List of education settings with confirmed RAAC as of **16 October 2023**". Data likely to change, mistakes highly likely mine, please drop me an email if you have any suggestions / questions.
...
-   The return rate for each LA is still unclear. Low occurance of RAAC might be due to high return rate. This needs clearing up.
